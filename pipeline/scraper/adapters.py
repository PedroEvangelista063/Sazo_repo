...
class AgrolinkCEASAAdapter(ScraperAdapter):
    """Adapter for Agrolink CEASA aggregator.

    Scrapes https://www.agrolink.com.br/cotacoes/ceasa/ceasa---{uf}
    which returns a table with Produto | CEASA | Preço | Data
    covering 40+ CEASAs across Brazil.
    """
