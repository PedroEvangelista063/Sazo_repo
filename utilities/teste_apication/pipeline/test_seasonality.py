"""
TÍTULO: Testes do Motor de Sazonalidade (Pipeline)
ESCOPO: Valida semáforo VERDE/AMARELO/VERMELHO/INSUFICIENTE e fallback município→UF
EXECUTA: Funções calculate_seasonality_municipio, calculate_seasonality_uf, apply_municipio_fallback em pipeline.seasonality
"""
