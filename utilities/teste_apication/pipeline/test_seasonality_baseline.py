"""
TÍTULO: Testes do Baseline 2025 + Fallback Híbrido 12m (Pipeline)
ESCOPO: Valida semáforo com Ano Âncora 2025, fallback condicional 12m, edge cases e filtro B2C
EXECUTA: Lógica idêntica à SP sp_calcular_sazonalidade_baseline em Polars (4 CTEs) — sem dependência de banco

Cenários testados (spec Fase 6 v2):
