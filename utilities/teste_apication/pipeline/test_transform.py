"""
TÍTULO: Testes do Módulo de Transformação (Pipeline)
ESCOPO: Valida normalização de colunas, parser de preço (vírgula→ponto), remoção de outliers Z-score
EXECUTA: Funções _normalize_column_names, _parse_price_column, _remove_outliers_zscore em pipeline.transform
"""
